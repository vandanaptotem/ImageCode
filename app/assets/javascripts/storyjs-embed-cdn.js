...
function createStoryJS(e, t) {
    ...
    try {
        ...
        l.has_jquery = !0;
        if (l.has_jquery) {
            var m = jQuery.fn.jquery.split("."), g = a.split(".");
            l.jquery = !0;
...
var WebFontConfig;
if (typeof embed_path == "undefined")var _tmp_script_path = getEmbedScriptPath("storyjs-embed.js"), embed_path = _tmp_script_path.substr(0, _tmp_script_path.lastIndexOf("js/"));
(function () {
